...
c1 = ufloat(slope1,std_err1)
c2 = ufloat(slope2,std_err2)
c3 = ufloat(slope3,std_err3)
c4 = ufloat(slope4,std_err4)
c5 = ufloat(slope5,std_err5)
print("für L=75 mm ist c=", c1*2*0.075)
print("für L=150mm ist c=",c2*2*0.15)
print("f+r L=225 ist c=",c3*2*0.225)
print("für L=300 ist c=",c4*2*0.30)
print("f+r L=600 ist c=",c5*2*0.60)
